...
namespace KitchenManager
{
    public partial class AddEmployeeWindow : Window
    {
        ...
        {
            ComboPosition.ItemsSource = KitchenBaseEntities.GetContext().Positions.ToList();
        }
        ...
        private void BtnSave_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                MessageBox.Show("Заполните ФИО и должность!", "Внимание", MessageBoxButton.OK, MessageBoxImage.Warning);
                return;
            }
            ...
            {
                KitchenBaseEntities.GetContext().Employees.Add(_currentEmployee);
            }
